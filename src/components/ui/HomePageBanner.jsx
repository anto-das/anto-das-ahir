...
const HomePageBanner = () => {
  ...
  return (
    <div
      id="top"
      className="min-h-screen pt-24 pb-12 flex justify-center items-center bg-[#0a0e18] relative overflow-hidden"
    >
        ...
        <div className="w-11/12 max-w-7xl space-y-12 lg:space-y-0 flex mx-auto justify-between items-center flex-col lg:flex-row-reverse gap-6">
          ...
          <div className="space-y-6 w-full lg:w-1/2 flex flex-col justify-center">
            ...
            <div className="space-y-3" data-aos="fade-up" data-aos-delay="100">
              ...
              <div className="text-lg md:text-xl font-bold text-slate-300 flex items-center gap-2">
                <span className="text-slate-500 font-medium">
                  Crafting secure & scalable architectures.
                </span>
              </div>
            </div>
            ...
            <p
              ...
              data-aos-delay="200"
            >
              Hi, I am a dedicated software craftsman who architects
              high-performance, responsive, and pixel-perfect full-stack web
              platforms. Fully committed to transforming intricate design
              paradigms into production-ready systems.
            </p>
            ...
            <div
              className="pt-4 border-t border-slate-900/60 w-full"
              data-aos="fade-up"
              data-aos-delay="400"
            >
              <span className="text-[10px] font-bold text-slate-500 uppercase tracking-[0.2em] block mb-3">
                Sync Node Channels
              </span>
              <SocialIcons />
            </div>
