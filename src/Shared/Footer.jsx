  ...
  return (
    <footer className="pb-14 border-t py-10 ">
     <div className="w-11/14 mx-auto">
       <div className="footer lg:gap-x-8 sm:footer-horizontal text-base-content py-14 border-b border-[#2a30357c]">
        {/* logo */}
        <aside className="space-y-3">
          <Link to={"/"}>
            <Logo></Logo>
          </Link>
          <span className="text-md max-w-[440px] bg-none text-gray-400 capitalize">
          ...
          <button  className="btn bg-[#0a1e1b] shadow-none border border-[#2aed64a1] items-center text-[16px] text-[#2aed64a2] btn-lg transition-transform duration-900 hover:-translate-y-0.5"
                ><GoDotFill className="mt-1 text-lg animate__animated animate__flash animate__delay-1 animate__infinite	infinite animate__slower"/> Available for Projects</button>
        </aside>
        {/* navigate */}
        ...
        {/* get in touch */}
        <nav className="space-y-3 lg:space-y-5 w-full">
          <h1 className="text-lg text-white font-semibold uppercase">get in touch</h1>
          <div className="flex gap-3 items-center">
            <IoMail className="text-4xl p-2 bg-[#0d172b] rounded-lg text-blue-600" />
            <p className="text-gray-400 text-[14px] lg:text-xl hover:text-blue-500 duration-500">
              antodasahir@gmail.com
            </p>
          </div>
           <a href="contact" className="capitalize w-1/2 btn bg-[#0e132248] shadow-none border border-[#2a6bed5e] flex gap-4 items-center text-[16px] font-bold text-[#2a6beddc] btn-lg transition-transform duration-900 hover:-translate-y-0.5">
          contact
        </a>
        </nav>
        {/* services */}
      ...
      <div className="flex flex-col lg:flex-row pt-5 space-y-5 justify-between items-center">
